        ...
        <div className="tt-body">
          <div className="tt-body-row">
            ...
            {[1, 2, 3, 4, 5].map((v, i) => {
              return (
                <div key={i}>
                  {tt[i][0].length === 0 ? "" : tt[i][0][0].course_unit_name}
                </div>
              );
            })}
            <div></div>
          ...
          <div className="tt-body-row">
            ...
            {[1, 2, 3, 4, 5].map((v, i) => {
              return (
                <div key={i}>
                  {tt[i][1].length === 0 ? "" : tt[i][1][0].course_unit_name}
                </div>
              );
            })}
            <div></div>
          ...
          <div className="tt-body-row">
            ...
            {[1, 2, 3, 4, 5].map((v, i) => {
              return (
                <div key={i}>
                  {tt[i][2].length === 0 ? "" : tt[i][2][0].course_unit_name}
                </div>
              );
            })}
            <div></div>
          ...
          <div className="tt-body-row">
            ...
            {[1, 2, 3, 4, 5].map((v, i) => {
              return (
                <div key={i}>
                  {tt[i][3].length === 0 ? "" : tt[i][3][0].course_unit_name}
                </div>
              );
            })}
            <div></div>
          ...
          <div className="tt-body-row">
            ...
            {[1, 2, 3, 4, 5].map((v, i) => {
              return (
                <div key={i}>
                  {tt[i][4].length === 0 ? "" : tt[i][4][0].course_unit_name}
                </div>
              );
            })}
            <div></div>
          ...
          <div className="tt-body-row">
            ...
            {[1, 2, 3, 4, 5].map((v, i) => {
              return (
                <div key={i}>
                  {tt[i][5].length === 0 ? "" : tt[i][5][0].course_unit_name}
                </div>
              );
            })}
            <div></div>
          ...
          <div className="tt-body-row">
            ...
            {[1, 2, 3, 4, 5].map((v, i) => {
              return (
                <div key={i}>
                  {tt[i][6].length === 0 ? "" : tt[i][6][0].course_unit_name}
                </div>
              );
            })}
            <div></div>
          ...
          <div className="tt-body-row">
            ...
            {[1, 2, 3, 4, 5].map((v, i) => {
              return (
                <div key={i}>
                  {tt[i][7].length === 0 ? "" : tt[i][7][0].course_unit_name}
                </div>
              );
            })}
            <div></div>
          ...
          <div className="tt-body-row">
            ...
            {[1, 2, 3, 4, 5].map((v, i) => {
              return (
                <div key={i}>
                  {tt[i][8].length === 0 ? "" : tt[i][8][0].course_unit_name}
                </div>
              );
            })}
            <div></div>
